...
programa
{
	 ...
	 * O cálculo é feito multiplicando a quantidade de itens vendido pelo preço de cada item
	*/
	...
	escreva("Você comrpou ", qtd_sobremesa, " sobremesas.\n")
	escreva("===================================================================\n")
